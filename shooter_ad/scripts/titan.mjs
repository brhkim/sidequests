...
function fastForward(targetDps) {
  ...
  while (squadDps(par) < targetDps && offer < 400) {
    ...
    const ctx = { power: par.power, damageBonus: par.upgrades.damageBonus, rateBonus: par.upgrades.rateBonus, guns: par.upgrades.guns, pierce: par.upgrades.pierce, sense: par.upgrades.sense, shield: par.upgrades.shield };
