...
const TOPICS: readonly Topic[] = [
  ...
  { key: 'cards', label: 'THE CARDS', color: 0xff6b4a, text:
    'A card names a stat and how much it grows: +25% DMG, ×1.25 DMG, +1 GUNS, +12 ARMY. You get whichever card you are standing under when the row reaches your line - only one of the three. Stand between cards and you get nothing (a MISS). Late on, the cards narrow and then sway inside their lane; the faint grey track behind one is how far it can go. +ECHO is a ghost army beside yours that fires what you fire: half-size left, half-size right, then each grows to full.' },
  ...
  { key: 'damage', label: 'TAKING DAMAGE', color: 0xff4d5e, text:
    'Enemies walk down the screen. One that touches your squad, or slips past it over the red line, takes soldiers away - more for bigger enemies. Enemy shots cost a little too: the small magenta darts one soldier in a hundred, the slow red shells a Mortar lobs twice that. Every price is a share of the BIGGEST army you have held this run, not of what is left: losing soldiers never makes the next hit cheaper until you are under half your best, and it holds there. Step out of a shell\'s way. At zero soldiers the run ends.' },
